...
int main()
{
    ...
    Endereco EnderecoJorge;
    EnderecoJorge.SetPais("Brasil");
    EnderecoJorge.setEstado("Minas Gerais");
    EnderecoJorge.SetCidade("Belo Horizonte");
    EnderecoJorge.SetRua("Rua entre as arvores");
    EnderecoJorge.SetNumero(22);
    EnderecoJorge.SetComplemento(103);
    ...
    Jorge.SetEnderecoAtual(EnderecoJorge);
    cout << Jorge.GetEnderecoAtual() << endl;
